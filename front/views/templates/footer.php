        ...
        <footer class="container">
            ...
            <div class="row mb-3">
                <div class="col-md-3 black-text">
                    To join the Crowdin community or bring your language to further
                    completion, go to Crowdin’s PrestaShop page and register.
                </div>
                ...
                <div class="col-md-3 black-text">
                    ...
                    of the 8 version, the current major version of PrestaShop.
                </div>
            </div>
            <div class="row justify-content-center align-items-center">
                <div class="col-md-3">
                    <a href="https://crowdin.com/project/prestashop-official" class="cta--pattern cta"><span>Translate
                            now<svg version="1.1" id="Calque_1" xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 9 10"
                                style="enable-background:new 0 0 9 10;" xml:space="preserve">
                                <path d="M9,5l-9,5L0,0L9,5z"></path>
                            </svg></span></a>
                </div>
                <div class="col-md-4">
                    <a href="https://build.prestashop-project.org/assets/ext/PrestaShop_Translator_Guide.pdf"
                        class="cta--pattern cta"><span>Download
                ...
                <div class="col-md-3">
                    <a href="https://www.prestashop-project.org/releases/" class="cta--pattern cta"><span>Discover
                            <svg version="1.1" id="Calque_1" xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 9 10"
                                style="enable-background:new 0 0 9 10;" xml:space="preserve">
                                <path d="M9,5l-9,5L0,0L9,5z"></path>
        ...
        S8.2,9.1,7.4,9.1l0,0H4.9V4.2z"></path>
        ...
        c0.5,0.4,0.7,1,0.7,1.8S26.9,8,26.4,8.4z"></path>
                            <polygon
                                points="40,11.4 46.4,11.4 46.4,7.5 40,7.5 40,4.3 48,4.3 48,0.2 35.1,0.2 35.1,18.8 48.3,18.8 48.3,14.7 40,14.7 ">
                            </polygon>
                            <path
                                d="M64.6,16c0.7-0.9,1-2,1-3.1c0-1.2-0.3-2.1-0.8-2.9c-0.5-0.7-1.2-1.3-2-1.6C62,8,61,7.7,59.7,7.5C58.4,7.2,57.5,7,57,6.9
        ...
        s1.9-1.5,3.2-1.5s2.4,0.5,3.2,1.5s1.2,2.3,1.2,3.9S150.1,12.4,149.3,13.4z"></path>
        ...
        c0.5,0.4,0.7,1,0.7,1.8S167.8,8,167.3,8.4z"></path>
                ...
                <div class="col-xs-10">
                    <ul class="list-style-none p-0">
                        <li class="d-inline-block">
                            <a href="https://build.prestashop-project.org/">Blog</a>
                        </li>
                        <li class="d-inline-block">
                            <a href="https://github.com/PrestaShop/PrestaShop/">Github</a>
                        </li>
                        <li class="d-inline-block">
                            <a href="https://www.prestashop-project.org/slack/">Slack</a>
                        </li>
                    </ul>
                    <ul class="list-unstyled ">
                        <li class="d-inline-block">
                            <a href="https://docs.prestashop-project.org/v.8-documentation/v/english/">User
                                documentation</a>
                        </li>
                        <li class="d-inline-block">
                            <a href="https://devdocs.prestashop-project.org/">Developer documentation</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row small">
                <div class="col-md-4">
                    ...
                    <a href="https://creativecommons.org/licenses/by-sa/4.0/legalcode" target="_blank">Creative
